...
import 'pages/expeditions/expeditions_controller.dart';
import 'pages/fournisseurs/fournisseurs_controller.dart';
import 'pages/rapports/journal_controller.dart';
import 'pages/materiels/materiels_controller.dart';
import 'pages/poissons/poisson_controller.dart';
import 'pages/produits/produits_controller.dart';

void main() async {
  //
  AgentsController agentsController = Get.put(AgentsController());
  ProduitsController produitsController = Get.put(ProduitsController());
